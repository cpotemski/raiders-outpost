...
const en = {
  ...
  communitySearchPlaceholder: "SEARCH COMMUNITY...",
  sortByLabel: "Sort",
  sortByMembers: "Members",
  sortByName: "Name",
  noCommunitiesMatch: "No communities match the search.",
...
const de: Labels = {
  ...
  communitySearchPlaceholder: "COMMUNITY SUCHEN...",
  sortByLabel: "Sortierung",
  sortByMembers: "Mitglieder",
  sortByName: "Name",
  noCommunitiesMatch: "Keine Communities zur Suche gefunden.",
  ...
  communityInviteIntroBody:
    "Lade User ein, damit ihr zusammen verfolgen könnt, was für Projekte noch fehlt.",
  needsVerb: "benötigt",
